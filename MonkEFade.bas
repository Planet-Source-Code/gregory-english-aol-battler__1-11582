...
'•MONKEFADE.BAS by monk-e-god• (e-mail: monkegod@hotmail.com)

'version: 2
'updates: basically updated for vb4 users
'it shouldnt error now.  Ive had lots of
'complaints and even threats to release
'by bas under another name for use with
'vb4 from this one guy.
'I also added a thing that converts the
'HTML hex for the number to RGB so you
'can use it in the FadeByColor functions.
...
'values.  With up to 10 color fades
'the combinations are endless.  This
'bas also contains a unique fade preview
'sub that allows you to view fades in
'a rich textbox.

'Please do not steal my subs and functions,
